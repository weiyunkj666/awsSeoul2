...
export default function App() {
  ...
  const [liRegion, setLiRegion] = useState("ap-northeast-2");
  ...
  const [userdata, setUserdata] = useState("ap-northeast-2")
  const [gqRegion, setGqRegion] = useState("ap-northeast-2");
  const [ciRegion, setCiRegion] = useState("ap-northeast-2");
